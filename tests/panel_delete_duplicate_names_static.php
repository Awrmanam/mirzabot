...
foreach (['name_panel', 'code_panel', 'type', 'product_count'] as $field) {
...
assertDuplicatePanelStatic(strpos($identity, "return ['status' => 'integrity_error'") !== false, 'Multi-row integrity failure is not explicit.');
